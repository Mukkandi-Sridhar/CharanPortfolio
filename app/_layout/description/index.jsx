...
const phrase =
  'Turning raw footage into scroll-stopping stories. Reels, Shorts and social content — cut with rhythm, motion and sound that hits.';
        ...
        <div className='basis-7/12 lg:basis-3/12'>
          <ParallaxFade>
            <Balancer as='p' className='mt-2 text-base lg:text-lg'>
              The combination of storytelling, pacing, motion graphics and
              sound design positions me in a unique place in the short-form
              content world.
            </Balancer>
          </ParallaxFade>
        </div>
